 ...
 */
public class WudaozhishiModel  implements Serializable {
	...
	public void setWeilaifazhan(String weilaifazhan) {
		this.weilaifazhan = weilaifazhan;
	}
	
	/**
	 * 获取：未来发展
	 */
	public String getWeilaifazhan() {
		return weilaifazhan;
	}
