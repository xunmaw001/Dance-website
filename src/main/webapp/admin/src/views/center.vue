  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="所学舞种" prop="suoxuewuzhong">
          <el-input v-model="ruleForm.suoxuewuzhong"               placeholder="所学舞种" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'"  label="舞蹈等级" prop="wudaodengji">
          <el-select v-model="ruleForm.wudaodengji" placeholder="请选择舞蹈等级">
            <el-option
                v-for="(item,index) in yonghuwudaodengjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  mounted() {
    ...
    this.yonghuwudaodengjiOptions = "第一级,第二级,第三级,第四级,第五级,第六级,第七级,第八级,第九级,第十级,第十一级,第十二级,第十三级".split(',')
  },
  methods: {
