<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考级标题" prop="kaojibiaoti">
          <el-input v-model="ruleForm.kaojibiaoti" 
              placeholder="考级标题" clearable  :readonly="ro.kaojibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考级标题" prop="kaojibiaoti">
              <el-input v-model="ruleForm.kaojibiaoti" 
                placeholder="考级标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报考时间" prop="baokaoshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baokaoshijian" label="报考时间" prop="baokaoshijian">
              <el-input v-model="ruleForm.baokaoshijian" 
                placeholder="报考时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="考级信息" prop="kaojixinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="考级信息"
                  v-model="ruleForm.kaojixinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kaojixinxi" label="考级信息" prop="kaojixinxi">
                    <span>{{ruleForm.kaojixinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="代理报名" prop="dailibaoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="代理报名"
                  v-model="ruleForm.dailibaoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dailibaoming" label="代理报名" prop="dailibaoming">
                    <span>{{ruleForm.dailibaoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='kaojibiaoti'){
            this.ruleForm.kaojibiaoti = obj[o];
	    this.ro.kaojibiaoti = true;
            continue;
          }
          if(o=='kaojixinxi'){
            this.ruleForm.kaojixinxi = obj[o];
	    this.ro.kaojixinxi = true;
            continue;
          }
          if(o=='baokaoshijian'){
	    ...
	    this.ro.zhuyishixiang = true;
          ...
          if(o=='dailibaoming'){
            this.ruleForm.dailibaoming = obj[o];
	    this.ro.dailibaoming = true;
            continue;
          }
          if(o=='zhaopian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wudaokaoji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wudaokaojiCrossAddOrUpdateFlag = false;
                  this.parent.search();
