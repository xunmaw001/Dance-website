<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="舞蹈标题" prop="wudaobiaoti">
          <el-input v-model="ruleForm.wudaobiaoti" 
              placeholder="舞蹈标题" clearable  :readonly="ro.wudaobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="舞蹈标题" prop="wudaobiaoti">
              <el-input v-model="ruleForm.wudaobiaoti" 
                placeholder="舞蹈标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.wuzhongtupian" label="舞种图片" prop="wuzhongtupian">
          <file-upload
          tip="点击上传舞种图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.wuzhongtupian?ruleForm.wuzhongtupian:''"
          @change="wuzhongtupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.wuzhongtupian" label="舞种图片" prop="wuzhongtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wuzhongtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="舞蹈等级" prop="wudaodengji">
          <el-input v-model="ruleForm.wudaodengji" 
              placeholder="舞蹈等级" clearable  :readonly="ro.wudaodengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="舞蹈等级" prop="wudaodengji">
              <el-input v-model="ruleForm.wudaodengji" 
                placeholder="舞蹈等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="舞蹈介绍" prop="wudaojieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="舞蹈介绍"
                  v-model="ruleForm.wudaojieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wudaojieshao" label="舞蹈介绍" prop="wudaojieshao">
                    <span>{{ruleForm.wudaojieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="舞蹈分析" prop="wudaofenxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="舞蹈分析"
                  v-model="ruleForm.wudaofenxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wudaofenxi" label="舞蹈分析" prop="wudaofenxi">
                    <span>{{ruleForm.wudaofenxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="咨询" prop="zixun">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="咨询"
                  v-model="ruleForm.zixun" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zixun" label="咨询" prop="zixun">
                    <span>{{ruleForm.zixun}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='wudaobiaoti'){
            this.ruleForm.wudaobiaoti = obj[o];
	    this.ro.wudaobiaoti = true;
            continue;
          }
          if(o=='wuzhongtupian'){
            this.ruleForm.wuzhongtupian = obj[o];
	    this.ro.wuzhongtupian = true;
            continue;
          }
          if(o=='wudaodengji'){
            this.ruleForm.wudaodengji = obj[o];
	    this.ro.wudaodengji = true;
            continue;
          }
          if(o=='shipin'){
	    ...
	    this.ro.shipin = true;
          ...
          if(o=='wudaojieshao'){
            this.ruleForm.wudaojieshao = obj[o];
	    this.ro.wudaojieshao = true;
            continue;
          }
          if(o=='wudaofenxi'){
            this.ruleForm.wudaofenxi = obj[o];
	    this.ro.wudaofenxi = true;
            continue;
          }
          if(o=='zixun'){
            this.ruleForm.zixun = obj[o];
	    this.ro.zixun = true;
            continue;
          }
          if(o=='thumbsupnum'){
      ...
      this.$http({
		...
		if(json.wudaodengji!=''&&json.wudaodengji){
              		this.ruleForm.wudaodengji = json.wudaodengji
		}
        } else {
    ...
    wuzhongtupianUploadChange(fileUrls) {
	this.ruleForm.wuzhongtupian = fileUrls;
			this.addEditUploadStyleChange()
    },
