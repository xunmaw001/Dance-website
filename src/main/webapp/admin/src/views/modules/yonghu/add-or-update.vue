<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="舞蹈等级" prop="wudaodengji">
          <el-select v-model="ruleForm.wudaodengji" placeholder="请选择舞蹈等级">
            <el-option
                v-for="(item,index) in wudaodengjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="所学舞种" prop="suoxuewuzhong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="所学舞种"
                  v-model="ruleForm.suoxuewuzhong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.suoxuewuzhong" label="所学舞种" prop="suoxuewuzhong">
                    <span>{{ruleForm.suoxuewuzhong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenfenzheng = true;
          ...
          if(o=='suoxuewuzhong'){
            this.ruleForm.suoxuewuzhong = obj[o];
	    this.ro.suoxuewuzhong = true;
            continue;
          }
          if(o=='wudaodengji'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.wudaodengjiOptions = "第一级,第二级,第三级,第四级,第五级,第六级,第七级,第八级,第九级,第十级,第十一级,第十二级,第十三级".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
