    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="发展历史" prop="fazhanlishi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fazhanlishi" label="发展历史" prop="fazhanlishi">
                    <span>{{ruleForm.fazhanlishi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="未来发展" prop="weilaifazhan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="未来发展"
                  v-model="ruleForm.weilaifazhan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weilaifazhan" label="未来发展" prop="weilaifazhan">
                    <span>{{ruleForm.weilaifazhan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fazhanlishi = true;
          ...
          if(o=='weilaifazhan'){
            this.ruleForm.weilaifazhan = obj[o];
	    this.ro.weilaifazhan = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.xiangxijieshao = this.ruleForm.xiangxijieshao.replace(reg,'../../../ssmb76fa/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wudaozhishi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wudaozhishiCrossAddOrUpdateFlag = false;
                  this.parent.search();
